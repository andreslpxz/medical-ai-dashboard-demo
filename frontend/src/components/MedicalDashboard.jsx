            ...
            <div className="space-y-6">
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                    <h3 className="text-lg font-semibold mb-4 flex items-center">
                        <Activity className="mr-2 text-blue-500" /> Metadatos del Paciente
                    </h3>
                    <div className="grid grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                            <p className="text-gray-500">Parte del Cuerpo</p>
                ...
                <div className="bg-white p-8 rounded-lg shadow-md border-t-4 border-t-blue-600">
                    <div className="flex justify-between items-start mb-6">
                        ...
                        <span className="bg-green-100 text-green-800 text-xs px-2 py-1 rounded flex items-center font-semibold">
                            <ShieldCheck className="w-3 h-3 mr-1" /> Validado por Guardrail
                        </span>
                    </div>

                    <div className="space-y-6">
                        <section>
                            <h4 className="text-sm font-bold text-gray-400 uppercase tracking-wider mb-2">Hallazgos</h4>
                            <p className="text-gray-700 leading-relaxed">{report.Findings}</p>
                        </section>

                        <section className="bg-blue-50 p-4 rounded-md">
                            <h4 className="text-sm font-bold text-blue-800 uppercase tracking-wider mb-2">Impresión</h4>
                            <p className="text-blue-900 font-medium">{report.Impression}</p>
                        </section>

                        <section>
                            <h4 className="text-sm font-bold text-gray-400 uppercase tracking-wider mb-2">Recomendaciones</h4>
